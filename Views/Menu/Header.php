...
<h2>Bienvenido, usted está en una sesión con una cuenta de Gerente</h2>'
;
}
...
<h2>Bienvenido, usted está en una sesión con una cuenta de Empleado</h2>'
;
  ...
  <li class="nav-item">
        <a href="#catalogo" class="nav-link active">
        <i class="nav-icon fas fa-columns"></i>
          <p>
...
<h2>Bienvenido, usted está en una sesión con una cuenta de Cliente</h2>'
;
}
?>
