...
<html lang="es">
	...
	<body>
		<div class="container">
			<h2 class="py-3">Registrarse</h2>
			
			<form id="nuevo" name="nuevo" method="POST" action="index.php?c=Login&a=saveCliente" autocomplete="off">
				...
				<div class="form-group">
					<input type="hidden" class="form-control" id="id_cargoUsuario" name="id_cargoUsuario" />
				</div>
